...
export const fetchDashboardUsers = (params) =>
  apiClient.get("/dashboard/users", { params });
export const fetchUserById = (id) => apiClient.get(`/dashboard/users/${id}`);
export const toggleUserStatus = (id) =>
  apiClient.patch(`/dashboard/users/${id}/status`);
export const fetchHospitalDashboard = () =>
  apiClient.get("/dashboard/hospital");
...
export const fetchMyHospital = () => apiClient.get("/hospitals/me");
...
export const toggleHospitalStatus = (id) =>
  apiClient.patch(`/hospitals/${id}/status`);

// Doctors
export const fetchDoctors = (params) => apiClient.get("/doctors", { params });
export const fetchDoctorById = (id) => apiClient.get(`/doctors/${id}`);

export const fetchMyHospitalDoctors = (params) =>
  apiClient.get("/doctors/my-hospital", { params });
...
export const fetchDoctorsByHospital = (hospitalId) =>
  apiClient.get(`/hospitals/${hospitalId}/doctors`);
export const fetchDoctorsBySpecialty = (specialtyId) =>
  apiClient.get(`/specialties/${specialtyId}/doctors`);

// Specialties
export const fetchSpecialties = (params) =>
  apiClient.get("/specialties", { params });
...
export const updateSpecialty = (id, data) =>
  apiClient.put(`/specialties/${id}`, data);
...
export const fetchSchedulesByDoctor = (doctorId, params) =>
  apiClient.get(`/doctors/${doctorId}/schedules`, { params });
export const createSchedule = (data) => apiClient.post("/schedules", data);
export const createBulkSchedules = (data) =>
...
export const fetchPatientPrescriptions = (patientId) =>
  apiClient.get(`/patients/${patientId}/prescriptions`);
