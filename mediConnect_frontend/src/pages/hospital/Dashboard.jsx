...
import {
  Box, Grid, Text, Stack, Badge, Table, Card, Flex, Button, Avatar,
} from '@chakra-ui/react'
import {
  MdPerson, MdEventNote, MdPeople, MdCalendarToday,
  MdSchedule, MdCheckCircle, MdArrowForward,
} from 'react-icons/md'
...
const STATUS_COLOR = { booked: 'green', pending: 'orange', completed: 'teal', cancelled: 'red' }
  ...
  return (
    <Stack gap={8}>
      <PageHeader
        ...
        actions={[
          <Button key="add" size="sm" colorPalette="teal" onClick={() => navigate('/hospital/doctors/add')}>
            + Add Doctor
          </Button>,
          <Button key="appts" size="sm" variant="outline" colorPalette="teal" onClick={() => navigate('/hospital/appointments')}>
            ...
            <Card.Body>
              <Flex justify="space-between" align="flex-start">
                <Box>
                  ...
                  <Text fontSize="3xl" fontWeight="800" color={`${color}.500`} lineHeight="1">
                    {value}
                  </Text>
                </Box>
                <Box color={`${color}.400`} bg={`${color}.50`} p={2.5} rounded="lg">
                  <Icon size={24} />
                </Box>
              </Flex>
            </Card.Body>
      ...
      <Grid templateColumns={{ base: '1fr', xl: '1fr 1fr' }} gap={6}>
        ...
        <Card.Root shadow="sm" rounded="xl">
          <Card.Header>
            <Flex justify="space-between" align="center">
              <Text fontWeight="700" fontSize="md">Our Doctors</Text>
        ...
        <Card.Root shadow="sm" rounded="xl">
          <Card.Header>
            <Flex justify="space-between" align="center">
              <Text fontWeight="700" fontSize="md">Recent Appointments</Text>
      ...
      <Card.Root shadow="sm" rounded="xl" bg="teal.700" color="white">
        <Card.Body>
          <Text fontWeight="700" fontSize="md" mb={4} color="white">Quick Actions</Text>
