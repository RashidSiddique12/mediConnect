...
import { fetchDashboardStats, fetchHospitalDashboard, fetchPatientDashboard } from '@/services/api'
...
export function* watchDashboardSaga() {
  yield takeLatest(dashboardSlice.fetchDashboardRequest.type, handleFetchDashboard)
}
